...
plt.subplot(121)
plt.imshow(np.random.normal(size=[128,128]), interpolation='nearest', cmap='viridis', origin='lower', extent=(-5,5,-5,5))
plt.xlabel('$x \, \mathrm{[arcsec]}$')
plt.ylabel('$y \, \mathrm{[arcsec]}$')
plt.title('$\mathrm{Gaussian}$')
plt.subplot(122)
plt.imshow(np.random.poisson(size=[128,128]), interpolation='nearest', cmap='viridis', origin='lower', extent=(-5,5,-5,5))
plt.xlabel('$x \, \mathrm{[arcsec]}$')
plt.ylabel('$y \, \mathrm{[arcsec]}$')
